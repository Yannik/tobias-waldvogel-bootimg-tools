...
static void avtab_reset_merged(avtab_t * a)
{
	unsigned int i;
	avtab_ptr_t cur;
	for (i = 0; i < a->nslot; i++) {
...
static int type_attr_uncount(hashtab_key_t key, hashtab_datum_t datum, void *args)
{
...
static int role_attr_uncount(hashtab_key_t key, hashtab_datum_t datum, void *args)
{
