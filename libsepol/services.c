...
static int compute_sid_handle_invalid_context(context_struct_t *
						     scontext,
						     context_struct_t *
						     tcontext,
...
static int convert_context_handle_invalid_context(context_struct_t *
							 context)
{
	if (selinux_enforcing) {
		return -EINVAL;
 ...
 */
static int convert_context(sepol_security_id_t key, context_struct_t * c, void *p)
{
 ...
 */
int hidden sepol_port_sid(uint16_t domain, uint16_t type , uint8_t protocol,
