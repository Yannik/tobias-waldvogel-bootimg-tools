...
static unsigned int ebitmap_start(const ebitmap_t * e, ebitmap_node_t ** n)
{
...
static void ebitmap_init(ebitmap_t * e)
{
	memset(e, 0, sizeof(*e));
}

static unsigned int ebitmap_next(ebitmap_node_t ** n, unsigned int bit)
{
...
static int ebitmap_node_get_bit(ebitmap_node_t * n, unsigned int bit)
{
