...
static struct policydb_compat_info policydb_compat[] = {
	{ POLICY_KERN, POLICYDB_VERSION_BOUNDARY, SYM_NUM, OCON_XEN_PCIDEVICE + 1, SEPOL_TARGET_XEN },
	{ POLICY_KERN, POLICYDB_VERSION_BASE, SYM_NUM - 3, OCON_FSUSE + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_KERN, POLICYDB_VERSION_BOOL, SYM_NUM - 2, OCON_FSUSE + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_KERN, POLICYDB_VERSION_IPV6, SYM_NUM - 2, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_KERN, POLICYDB_VERSION_NLCLASS, SYM_NUM - 2, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_KERN, POLICYDB_VERSION_MLS, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_KERN, POLICYDB_VERSION_AVTAB, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_KERN, POLICYDB_VERSION_RANGETRANS, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_KERN, POLICYDB_VERSION_POLCAP, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_KERN, POLICYDB_VERSION_PERMISSIVE, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_KERN, POLICYDB_VERSION_BOUNDARY, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_KERN, POLICYDB_VERSION_FILENAME_TRANS, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_KERN, POLICYDB_VERSION_ROLETRANS, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_KERN, POLICYDB_VERSION_NEW_OBJECT_DEFAULTS, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_KERN, POLICYDB_VERSION_DEFAULT_TYPE, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_KERN, POLICYDB_VERSION_CONSTRAINT_NAMES, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_KERN, POLICYDB_VERSION_IOCTL_OPERATIONS, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_BASE, MOD_POLICYDB_VERSION_BASE, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX,},
	{ POLICY_BASE, MOD_POLICYDB_VERSION_MLS, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX,},
	{ POLICY_BASE, MOD_POLICYDB_VERSION_MLS_USERS, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX,},
	{ POLICY_BASE, MOD_POLICYDB_VERSION_POLCAP, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX,},
	{ POLICY_BASE, MOD_POLICYDB_VERSION_PERMISSIVE, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX,},
	{ POLICY_BASE, MOD_POLICYDB_VERSION_BOUNDARY, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_BASE, MOD_POLICYDB_VERSION_BOUNDARY_ALIAS, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_BASE, MOD_POLICYDB_VERSION_FILENAME_TRANS, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_BASE, MOD_POLICYDB_VERSION_ROLETRANS, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_BASE, MOD_POLICYDB_VERSION_ROLEATTRIB, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_BASE, MOD_POLICYDB_VERSION_TUNABLE_SEP, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_BASE, MOD_POLICYDB_VERSION_NEW_OBJECT_DEFAULTS, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_BASE, MOD_POLICYDB_VERSION_DEFAULT_TYPE, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_BASE, MOD_POLICYDB_VERSION_CONSTRAINT_NAMES, SYM_NUM, OCON_NODE6 + 1, SEPOL_TARGET_SELINUX },
	{ POLICY_MOD, MOD_POLICYDB_VERSION_BASE, SYM_NUM, 0, SEPOL_TARGET_SELINUX,},
	{ POLICY_MOD, MOD_POLICYDB_VERSION_MLS, SYM_NUM, 0, SEPOL_TARGET_SELINUX,},
	{ POLICY_MOD, MOD_POLICYDB_VERSION_MLS_USERS, SYM_NUM, 0, SEPOL_TARGET_SELINUX,},
	{ POLICY_MOD, MOD_POLICYDB_VERSION_POLCAP, SYM_NUM, 0, SEPOL_TARGET_SELINUX,},
	{ POLICY_MOD, MOD_POLICYDB_VERSION_PERMISSIVE, SYM_NUM, 0, SEPOL_TARGET_SELINUX,},
	{ POLICY_MOD, MOD_POLICYDB_VERSION_BOUNDARY, SYM_NUM, 0, SEPOL_TARGET_SELINUX },
	{ POLICY_MOD, MOD_POLICYDB_VERSION_BOUNDARY_ALIAS, SYM_NUM, 0, SEPOL_TARGET_SELINUX },
	{ POLICY_MOD, MOD_POLICYDB_VERSION_FILENAME_TRANS, SYM_NUM, 0, SEPOL_TARGET_SELINUX },
	{ POLICY_MOD, MOD_POLICYDB_VERSION_ROLETRANS, SYM_NUM, 0, SEPOL_TARGET_SELINUX },
	{ POLICY_MOD, MOD_POLICYDB_VERSION_ROLEATTRIB, SYM_NUM, 0, SEPOL_TARGET_SELINUX },
	{ POLICY_MOD, MOD_POLICYDB_VERSION_TUNABLE_SEP, SYM_NUM, 0, SEPOL_TARGET_SELINUX },
	{ POLICY_MOD, MOD_POLICYDB_VERSION_NEW_OBJECT_DEFAULTS, SYM_NUM, 0, SEPOL_TARGET_SELINUX },
	{ POLICY_MOD, MOD_POLICYDB_VERSION_DEFAULT_TYPE, SYM_NUM, 0, SEPOL_TARGET_SELINUX },
	{ POLICY_MOD, MOD_POLICYDB_VERSION_CONSTRAINT_NAMES, SYM_NUM, 0, SEPOL_TARGET_SELINUX },
};
...
void level_datum_destroy(level_datum_t * x)
{
...
void cat_datum_destroy(cat_datum_t * x)
{
...
int policydb_role_cache(hashtab_key_t key, hashtab_datum_t datum, void *arg)
{
	policydb_t *p;
	role_datum_t *role;
...
int policydb_user_cache(hashtab_key_t key, hashtab_datum_t datum, void *arg)
{
	policydb_t *p;
	user_datum_t *user;
...
static int perm_read(policydb_t * p, hashtab_t h, struct policy_file *fp)
{
	char *key = 0;
...
static int type_read(policydb_t * p, hashtab_t h,
		     struct policy_file *fp)
{
	char *key = 0;
	type_datum_t *typdatum;
...
static int sens_read(policydb_t * p, hashtab_t h, struct policy_file *fp)
{
	char *key = 0;
	level_datum_t *levdatum;
	uint32_t buf[2], len;
...
static int cat_read(policydb_t * p, hashtab_t h, struct policy_file *fp)
{
	char *key = 0;
	cat_datum_t *catdatum;
	uint32_t buf[3], len;
