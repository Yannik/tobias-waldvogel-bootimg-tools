 ...
 */
static int mls_copy_context(context_struct_t * dst,
 ...
 */
static int mls_scopy_context(context_struct_t * dst,
				    context_struct_t * src)
{
	int l, rc = 0;
 ...
 */
static int mls_range_set(context_struct_t * context, mls_range_t * range)
{
	int l, rc = 0;
...
void mls_semantic_cat_destroy(mls_semantic_cat_t * c)
{
